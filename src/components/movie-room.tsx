...
export default function MovieRoom() {
  ...
  <main className="shell"><section className="intro"><div><p className="eyebrow">COMMUNITY WATCHLIST</p><h1>次に観る映画を、みんなで。</h1><p className="intro-copy">おすすめを投稿して、気になる一本に「観たい」を。ひとこと添えると、もっと伝わります。</p></div><button className="primary" onClick={openPost}><span aria-hidden="true">＋</span> 映画をおすすめする</button></section>
